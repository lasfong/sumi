...
Estimated remaining after the current batch: 3 large batches.

1. Analytics acceptance polish: setup/symbol/regime views, outlier contribution UI, drawdown period table, benchmark review.
2. Backtest/Strategy Lab product polish: saved backtest runs if separate from Strategy Lab, export/comparison ergonomics, sample MACD+RSI strategy pack.
3. Release hardening: final manual replay smoke, sample data flow, end-to-end smoke script, docs handoff, final UAT checklist and clean git release point.
